...
(function() {
  ...
  SpeedometerChartDirective = function($parse, $timeout) {
    var link;
    link = function(scope, element, attrs) {
      var SOLID_BLUE, SOLID_GREY, buildPaletteDataset, canvas, canvasId, chart, destroyChart, drawCenterText, drawPointer, drawScaleMarks, formatScaleValue, getGradientForValue, isRendering, renderChart, scheduleRender;
      ...
      buildPaletteDataset = function(segments, fallbackColor, maxRangeRatio) {
        var colorValue, colors, data, entries, j, len, scaleFactor, segment, segmentValue, totalRatio;
        ...
        for (j = 0, len = segments.length; j < len; j++) {
          ...
          colorValue = segment.color || SOLID_BLUE;
          entries.push({
            ratio: segmentValue,
            color: colorValue
          });
      ...
      renderChart = function(value, label, maxValue, rawValue, unit, metricKey, customColor, paletteSegments) {
        ...
        return ensureChartReady().then(function(ChartLib) {
          return $timeout(function() {
            var absoluteRatio, config, ctx, datasetColors, datasetData, datasetObject, error, gaugeBaseColor, gaugeFillStyle, gaugeRemainderColor, hasCustomScale, inputRatio, maxRefRatio, normalized, paletteDataset, ratioClamped;
            try {
              ctx = canvas.getContext('2d');
              if (!ctx) {
              ...
              if (typeof customColor === "string" && customColor.trim().length > 0) {
                gaugeBaseColor = customColor.trim();
              } else {
                gaugeFillStyle = getGradientForValue(ctx, normalized, label, metricKey);
                if ((gaugeFillStyle != null) && typeof gaugeFillStyle === "object" && gaugeFillStyle.fill) {
      ...
      getGradientForValue = function(ctx, value, label, metricKey) {
        var gradient, identifier, isAssignedMetric, isInternal, isWorsening, normalizedIdentifier, remainderGradient;
        ...
        if (isAssignedMetric) {
          remainderGradient.addColorStop(0, 'rgb(251, 191, 36)');
          remainderGradient.addColorStop(0.2, 'rgb(34, 197, 94)');
          remainderGradient.addColorStop(0.4, 'rgb(251, 191, 36)');
  ...
  AreaChartDirective = function($parse, $timeout) {
    ...
    link = function(scope, element, attrs) {
      ...
      renderChart = function(data) {
        ...
        return ensureChartReady().then(function(ChartLib) {
          return $timeout(function() {
            var areaColor, config, ctx, error, ref;
            try {
              ctx = canvas.getContext('2d');
              if (!ctx) {
              ...
              config = {
                ...
                options: {
                  ...
                  scales: {
                    ...
                    y: {
                      beginAtZero: true,
                      max: data.yAxisMax != null ? data.yAxisMax : void 0,
                      grid: {
                        display: true,
                        color: '#e2e8f0',
                        drawBorder: true,
                      ...
                      ticks: {
                        ...
                        stepSize: data.yAxisStep != null ? data.yAxisStep : void 0,
                        callback: function(value) {
                          var numericValue;
                  ...
                  plugins: {
                    legend: {
                      display: (ref = data.showLegend) != null ? ref : true,
                      position: 'top',
                      align: 'start',
                      labels: {
                        color: '#1e293b',
